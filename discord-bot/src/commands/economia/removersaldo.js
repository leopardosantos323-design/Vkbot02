...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription('[ADMIN] Remover saldo de um usuário')
    .addUserOption(o => o.setName('usuario').setDescription('Usuário').setRequired(true))
    .addNumberOption(o => o.setName('valor').setDescription('Valor a remover').setRequired(true).setMinValue(0.01)),
  async execute(interaction) {
    ...
    await interaction.reply({
      content: `✅ Removido **R$ ${valor.toFixed(2)}** de ${alvo}.\n💰 Saldo atual: **R$ ${novoSaldo.toFixed(2)}**`,
    });
  },
};
